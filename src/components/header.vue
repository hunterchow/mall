        ...
        <div class="md-content">
          <div class="confirm-tips">
            <div class="error-wrap">
              <span class="error" :class="{'error-show':errorTip}">用户名或密码错误!</span>
            </div>
            <ul>
              ...
              <li class="regi_form_input noMargin">
                ...
                <input type="password" tabindex="2" name="password" @keypress="enter"
                       class="regi_login_input" v-model="userPwd" autocomplete="new-password">
              </li>
            </ul>
          </div>
